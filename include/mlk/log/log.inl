...
namespace mlk
{
	namespace logger
	{
		inline log_base<log_level::normal>::log_base(
			bool save_history, bool write_on_exit, bool override_old_log,
			const std::string& save_path)
			: m_save_history{save_history},
			  m_write_on_exit{write_on_exit},
			  m_save_path{save_path},
			  m_mode{override_old_log ? std::ios::out | std::ios::trunc
		...
		inline void log_base<log_level::normal>::entry_added(
